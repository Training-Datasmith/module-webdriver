...
abstract class TestsForWeb extends Unit
{
    ...
    public function testSelectMultipleOptionsByText()
    {
        ...
        $this->module->click('Submit');
        $form = data::get('form');
        $this->assertSame(['play', 'adult'], $form['like']);
    }
    ...
    public function testSelectMultipleOptionsByValue()
    {
        ...
        $this->module->click('Submit');
        $form = data::get('form');
        $this->assertSame(['eat', 'adult'], $form['like']);
    }
    ...
    /**
     * Regression test
     * @issue https://github.com/Codeception/Codeception/issues/587
     */
    ...
    /**
     * @issue https://github.com/Codeception/Codeception/issues/1091
     */
    ...
    /**
     * @issue https://github.com/Codeception/Codeception/issues/1098
     */
    ...
    /**
     * @issue https://github.com/Codeception/Codeception/issues/1381
     */
    ...
    /**
     * @issue https://github.com/Codeception/Codeception/issues/1180
     */
    ...
    /**
     * @issue https://github.com/Codeception/Codeception/issues/1304
     */
    ...
    /**
     * @issue https://github.com/Codeception/Codeception/issues/1409
     */
    ...
    public function testFieldActionsWithPerformOn()
    {
        ...
        $this->assertSame('Test', $title2Value);
    }
}
